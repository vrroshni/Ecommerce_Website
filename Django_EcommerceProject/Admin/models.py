...
class Products(models.Model):
    ...
    Productimage_two      = models.ImageField(upload_to='Products_Image',default=True, null=True)
    Productimage_three    = models.ImageField(upload_to='Products_Image',default=True, null=True)
